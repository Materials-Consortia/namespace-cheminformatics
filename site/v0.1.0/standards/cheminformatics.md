# Standard defined by the cheminformatics definition provider (standard)
...
**ID: [`https://schemas.optimade.org/namespaces/cheminformatics/v0.1/standards/cheminformatics`](https://schemas.optimade.org/namespaces/cheminformatics/v0.1/standards/cheminformatics.md)**  
**Definition name:** `cheminformatics`

**Standard name:** Standard defined by the cheminformatics definition provider  
**Description:** Standard defined by the cheminformatics definition provider  

**Formats:** [[JSON](cheminformatics.json)] [[MD](cheminformatics.md)]

This standard defines the following entrytypes:

* **[Additional properties for structure endpoint defined by cheminformatics definition provider (structures)](../entrytypes/structures.md)** (entrytype) - [`https://schemas.optimade.org/namespaces/cheminformatics/v0.1/entrytypes/structures`](https://schemas.optimade.org/namespaces/cheminformatics/v0.1/entrytypes/structures.md)  
...
``` json
{
    "$id": "https://schemas.optimade.org/namespaces/cheminformatics/v0.1/standards/cheminformatics",
    "$schema": "https://schemas.optimade.org/meta/v1.2/optimade/standard_definition.json",
    "title": "Standard defined by the cheminformatics definition provider",
    "description": "Standard defined by the cheminformatics definition provider",
    "x-optimade-definition": {
        "label": "cheminformatics_standard",
        "kind": "standard",
        "format": "1.2",
        "version": "0.1.0",
